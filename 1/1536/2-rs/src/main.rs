// https://leetcode.com/problems/minimum-swaps-to-arrange-a-binary-grid/submissions/1935732234/?envType=daily-question&envId=2026-03-02

struct Solution;

impl Solution {
    fn tail_zeroes(arr: &Vec<i32>) -> i32 {
        arr.iter().rev().take_while(|x| **x == 0).count() as i32
    }
