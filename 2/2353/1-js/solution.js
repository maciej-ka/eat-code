// https://leetcode.com/problems/design-a-food-rating-system/submissions/1773362193
...
class FoodHeap {
  ...
  bubbleDown(i) {
    const c1 = (i << 1) + 1;
    if (c1 < this.foods.length && this.isGreater(c1, i)) {
      this.swap(c1, i);
      this.bubbleDown(c1);
    }

    const c2 = (i << 1) + 2;
    if (c2 < this.foods.length && this.isGreater(c2, i)) {
      this.swap(c2, i);
      this.bubbleDown(c2);
    }
  }
