defmodule SolutionTest do
  ...
  test "rob_line, empty" do
    assert Solution.rob_line([]) == 0
  end

  test "rob_line, one" do
    assert Solution.rob_line([2]) == 2
  end

  test "rob_line, two" do
    assert Solution.rob_line([2, 3]) == 3
  end

  test "rob_line, three" do
    assert Solution.rob_line([2, 3, 4]) == 6
  end
